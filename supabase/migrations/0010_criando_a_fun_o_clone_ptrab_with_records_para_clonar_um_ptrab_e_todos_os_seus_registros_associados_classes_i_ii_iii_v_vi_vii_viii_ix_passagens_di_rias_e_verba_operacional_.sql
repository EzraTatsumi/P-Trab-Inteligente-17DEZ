CREATE OR REPLACE FUNCTION public.clone_ptrab_with_records(
    old_ptrab_id uuid,
    new_user_id uuid,
    new_numero_ptrab text,
    new_rotulo_versao text
)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
    ...
    -- CLONE VERBA OPERACIONAL / SUPRIMENTO DE FUNDOS
