...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      diretrizes_material_consumo_categorias: {
        Row: {
          id: string
          user_id: string
          ano_referencia: number
      ...
      diretrizes_material_consumo_itens: {
        Row: {
          id: string
          categoria_id: string
          user_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "diretrizes_material_consumo_itens_categoria_id_fkey"
            columns: ["categoria_id"]
            isOneToOne: false
            referencedRelation: "diretrizes_material_consumo_categorias"
            referencedColumns: ["id"]
          },
        ]
      }
