...
import {
  ...
  ClasseVUpdate,
  ClasseV,
} from "@/integrations/supabase/classeV";
...
const formSchema = z.object({
  ...
  om_id: z.string().optional().nullable(), // ID da OM selecionada (não persistido na tabela classe_v_registros)
});

type ClasseVFormValues = z.infer<typeof formSchema>;
...
export function ClasseVForm({ pTrabId, initialData, onSuccess }: ClasseVFormProps) {
  ...
  const onSubmit = async (values: ClasseVFormValues) => {
    // ... (submission logic)
  };
