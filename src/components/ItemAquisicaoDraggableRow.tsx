...
const ItemAquisicaoDraggableRow: React.FC<ItemAquisicaoDraggableRowProps> = ({ item, diretrizId }) => {
    ...
    return (
        ...
        >
            ...
            <TableCell className="font-medium w-[45%] p-2">{item.descricao_item}</TableCell>
            <TableCell className="w-[15%] text-center text-xs p-2">{item.codigo_catmat || 'N/A'}</TableCell>
            <TableCell className="w-[10%] text-center p-2">{item.numero_pregao || 'N/A'}</TableCell>
            <TableCell className="w-[10%] text-center p-2">{formatCodug(item.uasg) || 'N/A'}</TableCell>
            <TableCell className="w-[10%] text-right font-bold text-primary p-2">
