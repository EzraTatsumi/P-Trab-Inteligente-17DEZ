                    ...
                    <Card className="p-4 space-y-4">
                        ...
                        <div className="border p-3 rounded-lg bg-muted/50 space-y-4" ref={itemFormRef}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                                ...
                                <div className="space-y-2"><Label>ND</Label><Input value={itemForm.nd} onChange={(e) => setItemForm({ ...itemForm, nd: e.target.value })} placeholder="30" /></div>
                            </div>
                        ...
                        {subitemForm.itens_aquisicao.length > 0 && (
                            <Table>
                                <TableHeader><TableRow><TableHead>Descrição</TableHead><TableHead>Nome Reduzido</TableHead><TableHead className="text-center">Cód.</TableHead><TableHead className="text-center">Pregão</TableHead><TableHead className="text-center">UASG</TableHead><TableHead className="text-right">Valor</TableHead><TableHead className="text-right">Ações</TableHead></TableRow></TableHeader>
