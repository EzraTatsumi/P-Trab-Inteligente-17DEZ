  ...
  const exportExcel = useCallback(async () => {
    ...
    try {
      ...
      omsOrdenadas.forEach((nomeOM) => {
        ...
        // NOVO: Exibindo Litros de Diesel (F)
        ...
        // NOVO: Exibindo Litros de Gasolina (G)
        ...
        // NOVO: Exibindo Valor Total de Combustível (H)
