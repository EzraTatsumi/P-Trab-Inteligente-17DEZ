...
interface VerbaOperacionalReportSectionProps {
    registros: VerbaOperacionalRegistro[];
    generateVerbaOperacionalMemoriaCalculo: GenerateMemoriaFn;
    title: string;
}
...
const VerbaOperacionalReportSection: React.FC<VerbaOperacionalReportSectionProps> = ({
    registros,
    ...
    return (
        <div className="space-y-6 print:space-y-4">
            ...
            {consolidatedGroups.map((group) => {
                ...
                const equipesText = group.quantidade_equipes === 1 ? 'equipe' : 'equipes';
                    ...
                    <div key={group.groupKey} className="border p-4 rounded-lg bg-white shadow-sm print:border-none print:p-0 print:shadow-none print:mb-4">
                        ...
                        <div className="flex justify-between items-start border-b pb-2 mb-3 print:border-b print:pb-1 print:mb-1">
                            <div className="flex flex-col">
                                ...
                                <p className="text-sm text-muted-foreground print:text-xs">
                                    Período: {group.dias_operacao} {diasText} | Qtd Equipes: {group.quantidade_equipes} {equipesText} | Fase: {formatFasesParaTexto(group.fase_atividade)}
                                </p>
                                {isDifferentOm && (
                        ...
                        <div className="mt-4 pt-3 border-t border-gray-200 print:border-gray-400">
                            ...
                            <pre className="text-xs whitespace-pre-wrap font-mono bg-gray-50 p-2 rounded print:bg-white print:p-0 print:text-[10px] print:border-none">
                                {generateVerbaOperacionalMemoriaCalculo(group.records[0])}
                            </pre>
                        </div>
                    </div>
                );
...
export default VerbaOperacionalReportSection;