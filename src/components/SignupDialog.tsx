...
export const SignupDialog: React.FC<SignupDialogProps> = ({
  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    // Se houver uma correção sugerida, forçamos o usuário a confirmar ou corrigir
    if (suggestedEmailCorrection) {
        setError(`Você quis dizer ${suggestedEmailCorrection}? Por favor, corrija o e-mail antes de continuar.`);
        return;
    }
