...
const ServicoCatalogDialog: React.FC<ServicoCatalogDialogProps> = ({
    ...
    const handlePreSelect = (item: any) => {
        const newItem = {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>Catálogo de Subitens da ND 30.33.39 e 30.33.33 (Serviço de Terceiros e Locação)</DialogTitle>
                    <DialogDescription>
...
export default ServicoCatalogDialog;