...
const AcquisitionGroupForm: React.FC<AcquisitionGroupFormProps> = ({ 
    ...
    return (
        <Card className="border-2 border-dashed border-primary/50 bg-primary/5 p-4">
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <Label htmlFor="groupName">Nome do Grupo de Aquisição *</Label>
                        <Input
                            id="groupName"
                            value={groupName}
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="Ex: Apoio à Seção de Pessoal"
                            disabled={isSaving}
                        />
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    <Label htmlFor="items">Itens de Aquisição ({items.length})</Label>
                ...
                <div className="flex justify-between gap-3 pt-2">
                    ...
                    <Button 
                        ...
                        className="flex-1"
                    >
                        {isSaving ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : (initialGroup ? "Atualizar Grupo" : "Adicionar Grupo")}
                    </Button>
