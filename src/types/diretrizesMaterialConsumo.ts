...
export interface ItemAquisicao {
    ...
    // Campos opcionais para quando o item está em um contexto de planejamento (P Trab)
    quantidade?: number;
    valor_total?: number;
    nd?: string;
    nr_subitem?: string;
...
// Tipos específicos para a funcionalidade de Grupos de Planejamento no P Trab
