...
// =================================================================
// FUNÇÕES DE NORMALIZAÇÃO E IDENTIFICAÇÃO DA RM (MOVIDAS DE PTrabReportManager)
// =================================================================

/**
 * Normaliza o nome de uma OM (maiúsculas, sem acentos, espaços simples).
 */
...
/**
 * Verifica se o nome de uma OM corresponde a uma Região Militar (RM).
 * @param nomeOM O nome da OM a ser verificada.
 * @param nomeRM O nome da Região Militar de vinculação do PTrab.
 */
