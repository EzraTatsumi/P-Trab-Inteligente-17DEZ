...
export const sanitizeAuthError = (error: any): string => {
  ...
  // Captura o erro específico de credenciais inválidas pelo código ou pela mensagem
  if (code === 'invalid_credentials' || message.includes('Invalid login') || message.includes('invalid_credentials')) {
