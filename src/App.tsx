...
import { PTrabProvider } from "./context/PTrabContext"; // Importar PTrabProvider
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <SessionContextProvider>
            <PTrabProvider> {/* Envolvendo as rotas com PTrabProvider */}
              <Routes>
                ...
                <Route path="/ptrab/classe-i/:ptrabId?" element={<ClasseIForm />} /> {/* Parâmetro opcional adicionado */}
                ...
                <Route path="/ptrab/diaria" element={<DiariaForm />} />
                <Route path="/ptrab/verba-operacional" element={<VerbaOperacionalForm />} />
                <Route path="/ptrab/suprimento-fundos" element={<SuprimentoFundosForm />} />
