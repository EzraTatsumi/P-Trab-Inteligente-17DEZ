...
const MaterialPermanenteForm = () => {
        ...
        mutationFn: async (itemsToSave: PendingPermanenteItem[]) => {
            ...
            const records = itemsToSave.flatMap(lote => {
                ...
                return items.map((item: any) => ({
                    ...
                    detalhes_planejamento: { item_unico: item, has_efetivo: lote.detalhes_planejamento.has_efetivo },
    ...
    return (
        <div className="min-h-screen bg-background p-4 md:p-8">
            ...
            <MaterialPermanenteBulkJustificativaDialog open={isBulkJustificativaOpen} onOpenChange={setIsBulkJustificativaOpen} items={selectedItems} onSave={handleSaveBulkJustificativas} />
