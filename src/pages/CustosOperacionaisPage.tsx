...
const CustosOperacionaisPage = () => {
  ...
  // Força a abertura instantânea para o Tour (Sempre atualizado)
  ...
  const handleOpenNewMaterialConsumoLocal = () => {
      setDiretrizMaterialConsumoToEdit(null);
      setIsMaterialConsumoFormOpen(true);
  };
