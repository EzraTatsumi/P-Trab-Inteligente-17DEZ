  ...
  useEffect(() => {
    ...
    if (startTour && ghost && missionId === '2') {
      ...
      const timer = setTimeout(() => {
        runMission02(() => {
          // O progresso agora é centralizado no driver
