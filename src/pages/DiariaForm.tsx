    ...
    const handleCalculateAndAdd = (e: React.FormEvent) => {
        ...
        try {
            ...
            const newPending: CalculatedDiaria = {
                ...
                calculosPorPosto: calculos.calculosPorPosto.map(calc => ({
                    ...calc,
                    valorTaxaEmbarque: formData.is_aereo ? calculos.totalTaxaEmbarque / calculos.totalMilitares : 0,
                    custoDiaria: calc.custoTotal, // O custo total da diária é o custo total neste contexto
                    custoTaxaEmbarque: formData.is_aereo ? (calculos.totalTaxaEmbarque / calculos.totalMilitares) * calc.quantidade : 0,
                    custoTotal: calc.custoTotal + (formData.is_aereo ? (calculos.totalTaxaEmbarque / calculos.totalMilitares) * calc.quantidade : 0),
                })),
