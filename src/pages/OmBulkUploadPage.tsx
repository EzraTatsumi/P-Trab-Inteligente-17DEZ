          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                disabled={loading}
                // Ajustando a altura do input e o padding do botão interno
                className="h-12 file:mr-4 file:py-1 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-primary-foreground hover:file:bg-primary/90"
              />
            </div>
