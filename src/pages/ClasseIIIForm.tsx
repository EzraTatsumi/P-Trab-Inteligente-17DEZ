...
import { generateGranularMemoriaCalculo } from "@/lib/classeIIIUtils";
  ...
  const { consolidadosCombustivel, consolidadoLubrificante, itensAgrupadosPorCategoria } = useMemo(() => {
    ...
    Object.entries(gruposPorCombustivel).forEach(([combustivel, itensGrupo]) => {
      ...
      itensGrupo.forEach(item => {
        ...
        // CORREÇÃO APLICADA AQUI: Adiciona o nome do item na linha de detalhe
            ...
            {getMemoriaRecords.length > 0 && (
              <div className="space-y-4 mt-8">
                ...
                {getMemoriaRecords.map(item => {
                  ...
                  // CORREÇÃO APLICADA AQUI: Usar o rótulo do categoryLabelMap para garantir a capitalização correta
