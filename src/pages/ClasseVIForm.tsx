...
import { ArrowLeft, HardHat, Loader2, AlertCircle } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Gerencie os itens de Classe VI para o P Trab: {ptrabNome}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Alert>
            ...
            <Table>
              ...
              <TableBody>
                {defaultClasseVIConfig.map((item, index) => (
                  <TableRow key={index}>
