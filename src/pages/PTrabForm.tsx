...
// Placeholder para CreditInputDialog (será recriado se necessário)
const CreditInputDialog = ({ open, onOpenChange, totalGND3Cost, totalGND4Cost, initialCreditGND3, initialCreditGND4, onSave }: any) => {
