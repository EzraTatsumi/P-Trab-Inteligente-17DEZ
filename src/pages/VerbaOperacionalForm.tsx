            ...
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Planejamento de verbas para custeio de operações militares.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-8">
                            ...
                            <section className="space-y-4 border-b pb-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                                    <div className="space-y-2">
                                        <Label>Objeto de Aquisição</Label>
                                    ...
                                    <div className="space-y-2">
                                        <Label>Objeto de Contratação</Label>
                                        <Input value={objetoContratacao} onChange={(e) => setObjetoContratacao(e.target.value)} placeholder="Ex: Pequenos reparos e serviços" disabled={!isPTrabEditable} />
                                    </div>
                                </div>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <Label>Propósito/Finalidade</Label>
                                        <Input value={proposito} onChange={(e) => setProposito(e.target.value)} placeholder="Ex: Atender necessidades operacionais" disabled={!isPTrabEditable} />
                                    </div>
                                    <div className="space-y-2">
                                            ...
                                            <Card key={item.tempId} className="border-2 shadow-md border-secondary bg-secondary/10">
                                                <CardContent className="p-4">
                                                    <div className="flex justify-between items-center pb-2 mb-2 border-b border-secondary/30">
                                                        <h4 className="font-bold text-base text-foreground">Verba Operacional</h4>
            ...
            <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Tem certeza que deseja excluir o registro de verba operacional?
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
