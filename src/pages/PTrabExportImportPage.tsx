    ...
    try {
      ...
      if (exportType === 'single' && selectedPTrabId) {
        ...
        const [
          ...
          supabase.from('classe_i_registros').select('*').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_i_registros'>>>,
          supabase.from('classe_ii_registros').select('*, itens_equipamentos, valor_nd_30, valor_nd_39').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_ii_registros'>>>,
          supabase.from('classe_iii_registros').select('*').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_iii_registros'>>>,
          supabase.from('classe_v_registros').select('*, itens_equipamentos, valor_nd_30, valor_nd_39').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_v_registros'>>>,
          supabase.from('classe_vi_registros').select('*, itens_equipamentos, valor_nd_30, valor_nd_39').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_vi_registros'>>>,
          supabase.from('classe_vii_registros').select('*, itens_equipamentos, valor_nd_30, valor_nd_39').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_vii_registros'>>>,
          supabase.from('classe_viii_saude_registros').select('*, itens_saude, valor_nd_30, valor_nd_39').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_viii_saude_registros'>>>,
          supabase.from('classe_viii_remonta_registros').select('*, itens_remonta, valor_nd_30, valor_nd_39').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_viii_remonta_registros'>>>,
          supabase.from('classe_ix_registros').select('*, itens_motomecanizacao, valor_nd_30, valor_nd_39').eq('p_trab_id', selectedPTrabId) as Promise<SupabaseArrayResponse<Tables<'classe_ix_registros'>>>,
          supabase.from('p_trab_ref_lpc').select('*').eq('p_trab_id', selectedPTrabId).maybeSingle() as Promise<SupabaseSingleResponse<Tables<'p_trab_ref_lpc'>>>,
        ]);
        ...
        const [
          ...
          supabase.from('p_trab').select('*, updated_at').eq('user_id', currentUserId) as Promise<SupabaseArrayResponse<Tables<'p_trab'>>>,
          supabase.from('classe_i_registros').select('*') as Promise<SupabaseArrayResponse<Tables<'classe_i_registros'>>>,
          supabase.from('classe_ii_registros').select('*, itens_equipamentos, valor_nd_30, valor_nd_39') as Promise<SupabaseArrayResponse<Tables<'classe_ii_registros'>>>,
          supabase.from('classe_iii_registros').select('*') as Promise<SupabaseArrayResponse<Tables<'classe_iii_registros'>>>,
          supabase.from('classe_v_registros').select('*, itens_equipamentos, valor_nd_30, valor_nd_39') as Promise<SupabaseArrayResponse<Tables<'classe_v_registros'>>>,
          supabase.from('classe_vi_registros').select('*, itens_equipamentos, valor_nd_30, valor_nd_39') as Promise<SupabaseArrayResponse<Tables<'classe_vi_registros'>>>,
          supabase.from('classe_vii_registros').select('*, itens_equipamentos, valor_nd_30, valor_nd_39') as Promise<SupabaseArrayResponse<Tables<'classe_vii_registros'>>>,
          supabase.from('classe_viii_saude_registros').select('*, itens_saude, valor_nd_30, valor_nd_39') as Promise<SupabaseArrayResponse<Tables<'classe_viii_saude_registros'>>>,
          supabase.from('classe_viii_remonta_registros').select('*, itens_remonta, valor_nd_30, valor_nd_39') as Promise<SupabaseArrayResponse<Tables<'classe_viii_remonta_registros'>>>,
          supabase.from('classe_ix_registros').select('*, itens_motomecanizacao, valor_nd_30, valor_nd_39') as Promise<SupabaseArrayResponse<Tables<'classe_ix_registros'>>>,
          supabase.from('p_trab_ref_lpc').select('*') as Promise<SupabaseArrayResponse<Tables<'p_trab_ref_lpc'>>>,
          supabase.from('organizacoes_militares').select('*').eq('user_id', currentUserId) as Promise<SupabaseArrayResponse<Tables<'organizacoes_militares'>>>,
          supabase.from('diretrizes_custeio').select('*').eq('user_id', currentUserId) as Promise<SupabaseArrayResponse<Tables<'diretrizes_custeio'>>>,
          supabase.from('diretrizes_equipamentos_classe_iii').select('*').eq('user_id', currentUserId) as Promise<SupabaseArrayResponse<Tables<'diretrizes_equipamentos_classe_iii'>>>,
        ]);
